...
enum SaleType {
  WHITELIST = CollectionConfig.whitelistSale.costNotFree,
  PRE_SALE = CollectionConfig.preSale.costNotFree,
  PUBLIC_SALE = CollectionConfig.publicSale.costNotFree,
};
...
describe(CollectionConfig.contractName, function () {
  ...
  it('Whitelist sale', async function () {
    ...
    await contract.setCost(utils.parseEther(CollectionConfig.preSale.costNotFree.toString()));
  ...
  it('Pre-sale (same as public sale)', async function () {
    ...
    await contract.setCost(utils.parseEther(CollectionConfig.publicSale.costNotFree.toString()));
  });
