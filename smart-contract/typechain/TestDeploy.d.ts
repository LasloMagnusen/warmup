...
interface TestDeployInterface extends ethers.utils.Interface {
  functions: {
    "approve(address,uint256)": FunctionFragment;
    "balanceOf(address)": FunctionFragment;
    "cost()": FunctionFragment;
    "costNotFree()": FunctionFragment;
    ...
    "maxMintAmountPerWalletFree()": FunctionFragment;
    ...
    "setCostNotFree(uint256)": FunctionFragment;
    "setHiddenMetadataUri(string)": FunctionFragment;
    "setMaxMintAmountPerTx(uint256)": FunctionFragment;
    "setMaxMintAmountPerWalletFree(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "maxMintAmountPerWalletFree",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "setCostNotFree",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setMaxMintAmountPerWalletFree",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export class TestDeploy extends BaseContract {
  ...
  functions: {
    ...
    costNotFree(overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    maxMintAmountPerWalletFree(overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    setMaxMintAmountPerWalletFree(
      _maxMintAmountPerWalletFree: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
  ...
  populateTransaction: {
    ...
    costNotFree(overrides?: CallOverrides): Promise<PopulatedTransaction>;
